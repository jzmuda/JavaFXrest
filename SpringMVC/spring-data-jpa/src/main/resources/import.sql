...
insert into book (id, title, authors, status) values (7, 'Seventh book', 'Bored W. Riter', 'FREE');
insert into book (id, title, authors, status) values (8, 'Eighth book', 'Origi Nail Titles', 'FREE');
insert into book (id, title, authors, status) values (9, 'Nineth book', 'Dr Frank N. Stein', 'FREE');
insert into book (id, title, authors, status) values (10, 'Tenth book', 'Watdid U Expect', 'FREE');
insert into book (id, title, authors, status) values (11, 'eleventh book', 'Too Lazy To Add More', 'FREE');
